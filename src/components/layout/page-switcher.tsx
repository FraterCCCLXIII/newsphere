      ...
      <DropdownMenu modal={false}>
        <DropdownMenuTrigger asChild>
          <Button
            ...
            size="sm"
            className={cn(
              "app-no-drag h-8 min-w-0 max-w-[min(16rem,calc(100vw-9rem))] shrink-0 gap-1 px-2 text-sm font-medium text-muted-foreground hover:bg-accent/80 hover:text-accent-foreground",
            )}
